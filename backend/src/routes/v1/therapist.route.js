...
router
  .route('/available')
  .get(therapistController.getAvailableTherapists);

router
  .route('/:therapistId')
  .get(therapistController.getTherapist)
  .patch(auth('manageTherapistProfile'), validate(therapistValidation.updateTherapist), therapistController.updateTherapistProfile);

router
  .route('/:therapistId/availability')
  .patch(auth('manageTherapistProfile'), validate(therapistValidation.updateAvailability), therapistController.updateAvailability);
...
router
  .route('/:therapistId/stats')
  .get(auth(), therapistController.getTherapistStats);
