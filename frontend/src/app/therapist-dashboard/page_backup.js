...
export default function TherapistDashboard() {
  ...
  useEffect(() => {
    ...
    console.log('✅ Registering all socket listeners');
    ...
    // Cleanup function - clean up ALL listeners
    return () => {
  ...
  }, [isConnected, onSessionMatched, onWaitingForTherapist, onSessionRequest, offSessionMatched, offWaitingForTherapist, offSessionRequest]); // Include all dependencies but use useCallback in useSocket to prevent re-runs
